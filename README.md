...
Everything is modular via [Kits](https://asylum.inventage.ai/dev/kits/) — enable what you need, disable what you don't.
...
Full reference: [Configuration documentation](https://asylum.inventage.ai/dev/configuration/)
...
Full reference: [Commands documentation](https://asylum.inventage.ai/dev/commands/)

## Kits

| Kit | Description | Default |
|-----|-------------|---------|
| [`node`](https://asylum.inventage.ai/dev/kits/node/) | Node.js LTS + npm/pnpm/yarn | Always on |
| [`python`](https://asylum.inventage.ai/dev/kits/python/) | Python 3 + uv | On |
| [`java`](https://asylum.inventage.ai/dev/kits/java/) | JDK 17/21/25 + Maven/Gradle | On |
| [`docker`](https://asylum.inventage.ai/dev/kits/docker/) | Docker-in-Docker | On |
| [`github`](https://asylum.inventage.ai/dev/kits/github/) | GitHub CLI | On |
| [`shell`](https://asylum.inventage.ai/dev/kits/shell/) | oh-my-zsh, tmux, direnv | Always on |
| [`ports`](https://asylum.inventage.ai/dev/kits/ports/) | Automatic port forwarding | Always on |
| [`openspec`](https://asylum.inventage.ai/dev/kits/openspec/) | [OpenSpec](https://openspec.dev) CLI | On |
| [`ast-grep`](https://asylum.inventage.ai/dev/kits/ast-grep/) | AST-based code search (`sg`) | Opt-in |
| [`browser`](https://asylum.inventage.ai/dev/kits/browser/) | Chromium via Playwright | Opt-in |
| [`cx`](https://asylum.inventage.ai/dev/kits/cx/) | Semantic code navigation | Opt-in |
| [`apt`](https://asylum.inventage.ai/dev/kits/apt/) | Extra system packages | Opt-in |

See the [full kits reference](https://asylum.inventage.ai/dev/kits/) for configuration details.
